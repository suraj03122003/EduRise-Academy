...
const CourseDetail = () => {
  ...
  if (isError || !data?.course) return <h1>Course not found.</h1>;

  const { course, purchased } = data || {};
  if (!course) return <h1>Course details not available</h1>;
        ...
        <div className="w-full lg:w-1/3">
          <Card>
            <CardContent className="p-4 flex flex-col">
              ...
              <h1>{course?.lectures?.length > 0 ? course.lectures[0]?.lectureTitle : "Lecture title unavailable"}</h1>
